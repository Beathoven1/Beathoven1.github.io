{
    $(document).ready(function () {
        ...
        //Работа прилипающего меню
        function scrollMenu(e) {
            //получаем высоту первого блока вместе с шапкой.
            var wid = $("section:nth-child(3)").offset();
            //получаем высоту шапки.
            var widHeader = $("section:nth-child(2)").offset();
            console.info(widHeader.top);
            $(window).scroll(function () {

                if ($(window).scrollTop() > wid.top) {
                    if ($('header').hasClass('scroll') == false) {
                        // $('header').fadeOut();
                        $('header').addClass('scroll');
                        $('.mainslide').css({'margin-top': widHeader.top});
                        // $('header').fadeIn();
                    }
                    ...
                    if ($('header').hasClass('scroll') == true) {
                        ...
                        $('section:nth-child(2)').css({'margin-top': 'auto'});
                    }
                }
            });
            /* $(window).scroll(function () {
                 if ($(window).scrollTop() > 770) {
                     $('header').addClass('scroll_zi');
                 } else {
                     $('.header').removeClass('scroll_zi')
                 }
             });*/
        };
        scrollMenu();
